  ...
  return (
    <section className="relative w-full">
      ...
      <div className="relative min-h-[650px] lg:min-h-[750px] flex items-center overflow-hidden pt-28 pb-32 lg:pt-32 lg:pb-40">
        ...
        />
        {/* Premium Dark Gradient Overlay using theme colors */}
        <div
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/30 z-0 pointer-events-none" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 flex flex-col lg:flex-row items-center gap-10 lg:gap-12">
          ...
          <div className="w-full lg:w-[55%] text-left pt-6 pb-6">
            ...
            <div className="flex flex-wrap gap-5 items-center">
              <a
                href="#cars"
                className="group relative overflow-hidden font-bold text-[15px] px-8 sm:px-10 py-3.5 sm:py-4 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 flex items-center gap-3"
                style={{
          ...
          <div className="w-full lg:w-[45%] relative min-h-[300px] lg:min-h-[350px] flex items-center justify-center">
            ...
            <div className="relative w-full max-w-[420px] space-y-3.5 sm:space-y-4 px-2 sm:px-0">
              ...
              <div
                ...
                className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 sm:p-5 flex items-center gap-4 text-white shadow-lg transform lg:translate-x-[-20px] hover:translate-x-0 transition-transform duration-300 animate-float"
              >
      ...
      {/* Stats Bar — fully theme-aware */}
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20 -mt-16 sm:-mt-24 mb-20">
        <div
          className="backdrop-blur-xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] p-6 sm:p-10 border"
          style={{
            background: "var(--t-card-bg, #FFFFFF)",
            borderRadius: "var(--t-radius, 1.5rem)",
            borderColor: "color-mix(in srgb, var(--t-primary) 12%, transparent)",
          }}
        >
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 divide-x-0 lg:divide-x"
            ...
            {[
              {
                ...
                label: "Member",
                icon: (
                  <svg className="w-6 h-6 sm:w-7 sm:h-7" fill="currentColor" viewBox="0 0 576 512">
              ...
              },
              {
                ...
                label: "Customer",
                icon: (
                  <svg className="w-6 h-6 sm:w-7 sm:h-7" fill="currentColor" viewBox="0 0 640 512">
              ...
              >
                {/* Icon container — theme primary bg on hover via stat-icon-container */}
                <div
                  className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-3 sm:mb-4 flex items-center justify-center transition-all duration-300 group-hover:scale-110 stat-icon-container"
                  style={{ borderRadius: "calc(var(--t-radius, 1rem) * 0.8)", color: "var(--t-primary)" }}
                >
                  {stat.icon}
                </div>
                ...
                {/* Accent divider dot */}
                <div
                  className="w-1.5 h-1.5 rounded-full mx-auto mb-2 opacity-60"
                  style={{ backgroundColor: "var(--t-accent)" }}
                />

                <h3
                  className="text-[22px] sm:text-[30px] font-extrabold leading-none mb-1 tabular-nums"
                  style={{ color: "var(--t-primary)" }}
                >
                  {stat.value}
                </h3>
                <p
                  className="text-[10px] sm:text-[12px] font-bold tracking-widest uppercase"
                  style={{ color: "color-mix(in srgb, var(--t-primary) 50%, #6b7280)" }}
                >
                  {stat.label}
                </p>
              </div>
